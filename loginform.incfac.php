<?php
  ...
  if(isset($_POST['regid']) && isset($_POST['password']))
  {
    ...
    {
      $query="SELECT id from Staff where Regid='".mysqli_real_escape_string($handle,$regid)."' and Password='".mysqli_real_escape_string($handle,$password)."'";
