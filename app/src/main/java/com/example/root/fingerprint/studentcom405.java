...
public class studentcom405 extends AppCompatActivity  {
    ...
    DatabaseReference databasecom405;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_studentcom405);
        databasecom405= FirebaseDatabase.getInstance().getReference("com403");
        btncom405s = (Button) findViewById(R.id.btncom402s);
        ...
        btncom405s.setOnClickListener(new View.OnClickListener() {
            @Override
